...
object WalletContainer2
    extends _root_.infrastructure.components.persistence.Container2[CommandsADT, CommandsADT.CreateWalletCmd.type, Event, State, OkResponse]:
